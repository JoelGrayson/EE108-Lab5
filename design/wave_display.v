...
`define HEIGHT_X 11'd800
`define HEIGHT_Y 10'd480
...
module wave_display (
    ...
    wire is_x_in_region = x >= `INIT_X + 4'd10 && x <= `INIT_X + `HEIGHT_X - 4'd10;
    wire is_y_in_region = y >= `INIT_Y + 4'd10 && y <= `INIT_Y + `HEIGHT_Y - 4'd10;
    assign valid_pixel = is_x_in_region & is_y_in_region;
    assign read_address = 9'b0;
